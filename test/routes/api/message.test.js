...
describe("API Message Routes", () => {
    ...
    beforeEach(() => {
        ...
        datetime.datetime_is_future = jest.fn()
            .mockResolvedValue(1);
    });
    ...
    describe("GET /api/message/:message_id", () => {
        it("should return message by id", async () => {
            ...
            expect(mockMessages.get)
                .toHaveBeenCalledWith({ message_id: "1" });
    ...
    describe("POST /api/message/:message_id", () => {
        ...
        it("should schedule message for future", async () => {
            ...
            expect(datetime.datetime_is_future)
                .toHaveBeenCalledWith("2025-12-31 23:59:59");
            expect(mockMessages.update)
                .toHaveBeenCalledWith(
                    { message_id: "1" },
        ...
        it("should reject past scheduling", async () => {
            ...
            expect(response.status)
                .toBe(400);
            expect(response.body)
                .toEqual({ message: "scheduled_at must be in the future" });
        });

        it("should not update when body is unchanged", async () => {
            const mockMessage = {
                message_id: 1,
                name: "Test Message",
                body: "Same Body",
            ...
            // Should return 204 (no changes)
            expect(response.status)
                .toBe(204);
        });

        it("should deactivate active message", async () => {
            const mockMessage = {
                message_id: 1,
                name: "Test Message",
                body: "Test body",
        ...
        it("should unset scheduled_at when dates cleared", async () => {
            const mockMessage = {
                message_id: 1,
                name: "Test Message",
                body: "Test body",
            ...
            const response = await request(app)
                .post("/api/message/1")
                .send({ name: "Updated" }); // No schedule_date or schedule_time

            expect(mockMessages.update)
                .toHaveBeenCalledWith(
                    { message_id: "1" },
                    { name: "Updated", scheduled_at: null },
                );
            expect(response.status)
                .toBe(200);
        });
        ...
        it("should return 500 when update fails", async () => {
            ...
            mockMessages.get.mockResolvedValue([mockMessage]);
            mockMessages.update.mockResolvedValue(null);
    ...
    describe("DELETE /api/message/:message_id", () => {
        ...
        it("should return 500 when delete fails", async () => {
            ...
            mockMessages.get.mockResolvedValue([mockMessage]);
            mockMessages.remove.mockResolvedValue(null);
    ...
    describe("POST /api/message/", () => {
        ...
        it("should return error for missing name", async () => {
            ...
            expect(response.status)
                .toBe(400);
            expect(response.body)
                .toEqual({ message: "The name and body parameters are required" });
        });
        ...
        it("should create message without active flag", async () => {
            mockMessages.create.mockResolvedValue([1]);
