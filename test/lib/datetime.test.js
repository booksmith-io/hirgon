...
describe("Datetime Utils", () => {
    ...
    describe("datetime_is_future validation", () => {
        ...
        it("should validate datetime regex pattern", () => {
            ...
            expect(datetime_regex.test("2025-12-31 23:59:59"))
                .toBe(true);
            expect(datetime_regex.test("2025-01-01 00:00:00"))
                .toBe(true);
            expect(datetime_regex.test("2025-06-15 14:30:45"))
                .toBe(true);
            expect(datetime_regex.test("2025-12-31"))
                .toBe(false);
            expect(datetime_regex.test("invalid"))
                .toBe(false);
            expect(datetime_regex.test("2025/12/31 23:59:59"))
                .toBe(false);
        });
    ...
    describe("localtime function", () => {
        it("should have localtime function exported", () => {
            expect(typeof datetime.localtime)
                .toBe("function");
        });

        it("should have datetime_is_future function exported", () => {
            expect(typeof datetime.datetime_is_future)
                .toBe("function");
        });
    });
});