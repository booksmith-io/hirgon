...
describe("Users Model", () => {
    ...
    describe("check_passwd_complexity method", () => {
        it("should return error when password is missing", () => {
            ...
            expect(result)
                .toEqual([false, "The password argument is required"]);
        });
