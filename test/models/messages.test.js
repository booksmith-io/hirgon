...
describe('Messages Model', () => {
  ...
  beforeEach(() => {
    ...
    expect(messages.dbh).toBeDefined();
  });

  describe('constructor', () => {
    it('should initialize with table name "messages"', () => {
      expect(messages._table).toBe('messages');
    });
  });
  ...
  describe('get method', () => {
    it('should work with selector and return expected structure', async () => {
      ...
      messages.get = jest.fn().mockResolvedValue(expectedResult);
  ...
  describe('remove method', () => {
    it('should delete message with correct selector', async () => {
      ...
      messages.remove = jest.fn().mockResolvedValue(expectedResult);
